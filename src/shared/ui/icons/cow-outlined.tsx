...
import type { CustomIconComponentProps } from "."

const CowSvg = (props: SVGProps<SVGSVGElement>) => (
...
const CowOutlined: FC<Partial<CustomIconComponentProps>> = (props) => {
	return (
		<>
			<Icon component={CowSvg} {...props} />
		</>
	)
}
