...
import type { CustomIconComponentProps } from "src/shared/ui/icons/index.ts"

const ParkingSvg: FC<SVGProps<SVGSVGElement>> = (props) => {
	return (
		<>
			<svg
				stroke={"currentColor"}
...
const ParkingOutlined: FC<Partial<CustomIconComponentProps>> = (props) => {
	return (
		<>
			<Icon
				component={ParkingSvg}
				{...props}
			/>
		</>
	)
